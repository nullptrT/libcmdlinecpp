...
int main( int argc, char** argv ) {
    ...
    // Define the program
    cmdline.set_program_name( "cmdlinecpp_test_last_positionals" );
    ...
    for ( unsigned int pos_param = 0; pos_param < param_list.size(); pos_param++ ) {
        std::cout << param_list.at( pos_param ) << std::endl;
    }
