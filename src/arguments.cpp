...
void CmdLineArguments::add_parameter_positional( const std::string param ) {
    Option option( param );
    m_positionals.push_back( option );
}


void CmdLineArguments::add_parameter_positional( Option option ) {
    m_positionals.push_back( option );
}


void CmdLineArguments::add_parameter_option( const std::string option, const char option_short ) {
    m_options.push_back( Option( option, option_short ) );
}


void CmdLineArguments::add_parameter_option( Option option ) {
    m_options.push_back( option );
}


bool CmdLineArguments::is_option( const std::string parameter ) const {
...
const Option CmdLineArguments::lookup_positional( const std::string option_name ) {
...
std::vector< Option > CmdLineArguments::parameters_positional() const {
    return m_positionals;
}


std::vector< Option > CmdLineArguments::parameters_options() const {
    return m_options;
}
