...
Action::Action( const std::string name, const std::string help_text )
    :   m_name( name )
...
const std::string Action::help_text() const {
    return m_help_text;
}


Action& Action::operator<<( const std::string help_text ) {
    m_help_text += help_text;
